...
export default function Register() {
    ...
    async function handleLoginRegister(e){
        ...
        try{
            ...
            alert(`Cadastro realizado com sucesso! Sua chave de acesso é: ${response.data.id}`);
            history.push('/');
        } catch(error){
            ...
            <div className="content">
                ...
                <form onSubmit={handleLoginRegister}>
                    ...
                    <div className="input-group">
                        ...
                        <input type="text" placeholder="UF" required style={{width: 80}} value={uf} onChange={e => setUf(e.target.value)}/>
                    </div>
